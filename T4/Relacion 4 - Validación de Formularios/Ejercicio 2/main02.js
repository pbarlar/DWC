function comprobacionRegistro() {
    ...
    name.addEventListener("blur",()=>{
      if (!expNombre.test(name.value)) {
        document.getElementById("nombre").innerHTML+="(Formato invalido)"
    ...
    dni.addEventListener("blur",()=>{
      if (!expDni.test(dni.value)) {
        document.getElementById("lbl_dni").innerHTML+="(Formato invalido)"
    ...
    tel.addEventListener("blur",()=>{
      if (!expTel.test(tel.value)) {
        document.getElementById("lbl_tel").innerHTML+="(Formato invalido)"
